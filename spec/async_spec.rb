...
describe CoinbasePrime::Exchange::AsyncClient do
  before :all do
    @client = CoinbasePrime::Exchange::AsyncClient.new('api_pass',
                                                  'api_key',
                                                  'api_secret')
  end
  ...
  it "raises BadRequestError on 400" do
    ...
    end.to raise_error CoinbasePrime::Exchange::BadRequestError
  end
  ...
  it "raises NotAuthorizedError on 401" do
    ...
    expect do
      EM.run { @client.orders { EM.stop } }
    end.to raise_error CoinbasePrime::Exchange::NotAuthorizedError
  end
  ...
  it "raises ForbiddenError on 403" do
    ...
    expect do
      EM.run { @client.orders { EM.stop } }
    end.to raise_error CoinbasePrime::Exchange::ForbiddenError
  end
  ...
  it "raises NotFoundError on 404" do
    ...
    expect do
      EM.run { @client.orders { EM.stop } }
    end.to raise_error CoinbasePrime::Exchange::NotFoundError
  end
  ...
  it "raises RateLimitError on 429" do
    ...
    expect do
      EM.run { @client.orders { EM.stop } }
    end.to raise_error CoinbasePrime::Exchange::RateLimitError
  end
  ...
  it "raises InternalServerError on 500" do
    ...
    expect do
      EM.run { @client.orders { EM.stop } }
    end.to raise_error CoinbasePrime::Exchange::InternalServerError
  end
end
